...
$(function() {
	...
	var allFiledsStr = '[{"_CN_":"ID","_KEY_":"ID"},{"_CN_":"角色名","_KEY_":"NAME","_NOT_NULL_":"1"},{"_CN_":"角色编码","_KEY_":"CODE"},{"_CN_":"角色状态","_KEY_":"STATUS","_NOT_NULL_":"1"},{"_CN_":"更新用户","_KEY_":"UPDATE_USER"},{"_CN_":"创建时间","_KEY_":"CREATE_TIME"},{"_CN_":"更新时间","_KEY_":"UPDATE_TIME"}]';
...
<form method="post" action="" id="searchForm">			
		<div class="mRtBox">
			...
			<div class="rTitle" >
				<h3><i class="title"></i><span id="title">角色管理</span></h3>
...
<option value='1' <#if searchbox["STATUS"] =='1'> selected='selected'</#if>>有效</option>
			...
			<div class="searchCenter">
				<input type="hidden" name="exportFields" value="NAME,CODE,STATUS,CREATE_TIME,UPDATE_TIME,UPDATE_USER"/>
	...
	<div align="center">
		<div class="add" >
			...
			<table width="100%" class="up_table" border="1">
				<th>角色名</th><th>角色编码</th><th>角色状态</th><th>创建时间</th><th>更新时间</th><th>更新用户</th>
			</table>
			<div class="rTitle" align="left">
				<h3>上传注意事项</h3>
			</div>
