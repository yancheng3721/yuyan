...
$(function() {
	...
	var allFiledsStr = '[{"_CN_":"ID","_KEY_":"ID"},{"_CN_":"菜单ID","_KEY_":"MENU_ID"},{"_CN_":"菜单名称","_KEY_":"MENU_NAME"},{"_CN_":"资源名称","_KEY_":"NAME","_NOT_NULL_":"1"},{"_CN_":"资源编码","_KEY_":"CODE","_NOT_NULL_":"1"},{"_CN_":"资源链接","_KEY_":"ACTION","_NOT_NULL_":"1"},{"_CN_":"备注","_KEY_":"REMARK","_NOT_NULL_":"1"},{"_CN_":"更新用户","_KEY_":"UPDATE_USER"},{"_CN_":"创建时间","_KEY_":"CREATE_TIME"},{"_CN_":"更新时间","_KEY_":"UPDATE_TIME"}]';
    ...
    function expand(obj){
    	if(obj.ID){
			$.ajax({
				url: '/yuyan/resource/expandResource.do',
				type: 'POST',
				dataType: 'json',
				timeout: 5000,
				data:obj,
	...
	function doBtchDel(){
		...
		$.ajax({
				url: '/yuyan/resource/batchDeleteResource.do',
				type: 'POST',
				dataType: 'json',
				timeout: 5000,
				data:{ids:ids},
	...
	function doSave(){
		...
		//alert(222);
		$.ajax({
				url: '/yuyan/resource/saveResource.do',
				type: 'post',
				dataType: 'json',
				timeout: 5000,
				data:params,
	...
	function doDelete(obj){
		...
		$.ajax({
				url: '/yuyan/resource/deleteResource.do',
				type: 'post',
				dataType: 'json',
				timeout: 5000,
				data:obj,
	...
	function doQuery(){
		...
		searchForm.attr("action","/yuyan/resource/queryResource.do");
		searchForm.submit();
	}
	...
	function syncData(){
		...
		$.ajax({
				url: '/yuyan/resource/syncResource.do',
				type: 'POST',
				dataType: 'json',
		...
		$('#sguploadForm').ajaxSubmit({
                ...
                success:function(data){
                	...
                	if (data.obj.message == "上传成功!") {
                	   window.location.href="/yuyan/resource/manageResource.do";
                	}
                },
                error:function(xhr){
	...
	function exportCsv() {
		var searchForm = $("#searchForm");
		var tmp = searchForm.attr("action");
		searchForm.attr("action","/yuyan/resource/exportResource.do");
		searchForm.submit();
...
<form method="post" action="" id="searchForm">			
		<div class="mRtBox">
			...
			<div class="rTitle" >
				<h3><i class="title"></i><span id="title">资源管理</span></h3>
			...
			<div class="searchCenter">
				...
				<table width="100%" class="searTabBg">
					<tr>
<td class='tdName'>资源名称：</td>
<td style='width:140px;'>
<input name='searchbox.NAME' type='text' id='searchbox.NAME'  value='${searchbox["NAME"]}' />
</td><td class='tdName'>资源编码：</td>
<td style='width:140px;'>
<input name='searchbox.CODE' type='text' id='searchbox.CODE'  value='${searchbox["CODE"]}' />
</td><td class='tdName'>资源链接：</td>
<td style='width:140px;'>
<input name='searchbox.ACTION' type='text' id='searchbox.ACTION'  value='${searchbox["ACTION"]}' />
</td></tr>
<tr>
<td class='tdName'>备注：</td>
<td style='width:140px;'>
<input name='searchbox.REMARK' type='text' id='searchbox.REMARK'  value='${searchbox["REMARK"]}' />
</td></tr>
			...
			<div class="searchCenter">
				<input type="hidden" name="exportFields" value="NAME,MENU_ID,MENU_NAME,CODE,ACTION,REMARK,CREATE_TIME,UPDATE_TIME,UPDATE_USER"/>
...
<td>${obj.UPDATE_USER}</td>
			...
			<div class="searchCenter pagenation" style="text-align:right">
				<script type="text/javascript">
					window.__page=new SnPage(document.getElementById("searchForm"),'/yuyan/resource/queryResource.do','${page.totalPage?c}','${page.currentPage?c}');
				</script>
...
<div id="saveDialog" title="资源保存" style="display:none" >
	<input type="hidden" class="savebox" name="saveboxID" id="saveboxID" >
	<div class="box-content">
	<table style="margin-top:10px;font-size:12px;">
		
		<tr style='height:35px;'>
<td width='140px' align='right'>资源名称：</td>
...
<tr style='height:35px;'>
<td width='140px' align='right'>资源编码：</td>
<td> <input type='text' class='savebox'  name='saveboxCODE' id='saveboxCODE' ></td>
</tr>
<tr style='height:35px;'>
<td width='140px' align='right'>资源链接：</td>
<td> <input type='text' class='savebox'  name='saveboxACTION' id='saveboxACTION' ></td>
</tr>
<tr style='height:35px;'>
...
<#--批量上传-->
<div class="showBox" id="batchupload" style="display:none;" title="资源批量上传">
	<form action="/yuyan/resource/uploadResource.do" method="POST" id="sguploadForm" name="sguploadForm" enctype="multipart/form-data" onsubmit="return false;">
		<div style="text-align: center;margin: 10px 0;">
			<span>路径：</span>
			<input type="hidden" name="importFields" value="NAME,MENU_ID,CODE,ACTION,REMARK"/>
	...
	<div align="center">
		<div class="add" >
			...
			<table width="100%" class="up_table" border="1">
				<th>资源名称</th><th>菜单ID</th><th>菜单名称</th><th>资源编码</th><th>资源链接</th><th>备注</th><th>创建时间</th><th>更新时间</th><th>更新用户</th>
			</table>
			<div class="rTitle" align="left">
				<h3>上传注意事项</h3>
			</div>
