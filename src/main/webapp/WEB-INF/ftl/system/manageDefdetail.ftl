...
$(function() {
	...
	var allFiledsStr = '[{"_CN_":"ID","_KEY_":"ID"},{"_CN_":"字典ID","_KEY_":"DOC_ID","_NOT_NULL_":"1"},{"_CN_":"字典编码","_KEY_":"DOC_CODE"},{"_CN_":"字典名称","_KEY_":"DOC_NAME"},{"_CN_":"字典键","_KEY_":"DEF_KEY","_NOT_NULL_":"1"},{"_CN_":"字典值","_KEY_":"DEF_VALUE","_NOT_NULL_":"1"},{"_CN_":"状态","_KEY_":"STATE","_NOT_NULL_":"1"},{"_CN_":"备注","_KEY_":"REMARK","_NOT_NULL_":"1"},{"_CN_":"更新用户","_KEY_":"UPDATE_USER"},{"_CN_":"创建时间","_KEY_":"CREATE_TIME"},{"_CN_":"更新时间","_KEY_":"UPDATE_TIME"}]';
	var allFileds = eval('('+allFiledsStr+')');
	var templateStr = '{"DOC_ID":"${searchbox.DOC_ID}"}';
	var tplt = eval('('+templateStr+')');
	//弹出保存框
    ...
    function expand(obj){
    	if(obj.ID){
			$.ajax({
				url: '/yuyan/defdetail/expandDefdetail.do',
				type: 'POST',
				dataType: 'json',
				timeout: 5000,
				data:obj,
	...
	function doBtchDel(){
		...
		$.ajax({
				url: '/yuyan/defdetail/batchDeleteDefdetail.do',
				type: 'POST',
				dataType: 'json',
				timeout: 5000,
				data:{ids:ids},
	...
	function doSave(){
		...
		//alert(222);
		$.ajax({
				url: '/yuyan/defdetail/saveDefdetail.do',
				type: 'post',
				dataType: 'json',
				timeout: 5000,
				data:params,
	...
	function doDelete(obj){
		...
		$.ajax({
				url: '/yuyan/defdetail/deleteDefdetail.do',
				type: 'post',
				dataType: 'json',
				timeout: 5000,
				data:obj,
	...
	function doQuery(){
		...
		searchForm.attr("action","/yuyan/defdetail/queryDefdetail.do");
		searchForm.submit();
	}
	...
	function syncData(){
		...
		$.ajax({
				url: '/yuyan/defdetail/syncDefdetail.do',
				type: 'POST',
				dataType: 'json',
		...
		$('#sguploadForm').ajaxSubmit({
                ...
                success:function(data){
                	...
                	if (data.obj.message == "上传成功!") {
                	   window.location.href="/yuyan/defdetail/manageDefdetail.do";
                	}
                },
                error:function(xhr){
	...
	function exportCsv() {
		var searchForm = $("#searchForm");
		var tmp = searchForm.attr("action");
		searchForm.attr("action","/yuyan/defdetail/exportDefdetail.do");
		searchForm.submit();
...
<form method="post" action="" id="searchForm">			
		<div class="mRtBox">
			...
			<div class="rTitle" >
				<h3><i class="title"></i><span id="title">业务字典值管理</span></h3>
...
<input name='searchbox.DOC_ID' type='hidden' id='searchbox.DOC_ID'  value='${searchbox["DOC_ID"]}' />
...
</td><td class='tdName'>字典键：</td>
<td style='width:140px;'>
<input name='searchbox.DEF_KEY' type='text' id='searchbox.DEF_KEY'  value='${searchbox["DEF_KEY"]}' />
</td></tr>
<tr>
<td class='tdName'>字典值：</td>
<td style='width:140px;'>
<input name='searchbox.DEF_VALUE' type='text' id='searchbox.DEF_VALUE'  value='${searchbox["DEF_VALUE"]}' />
</td></tr>
			...
			<div class="searchCenter">
				<input type="hidden" name="exportFields" value="DOC_CODE,DOC_NAME,DEF_KEY,DEF_VALUE,STATE,REMARK,CREATE_TIME,UPDATE_TIME,UPDATE_USER"/>
...
<td>${obj.UPDATE_USER}</td>
			...
			<div class="searchCenter pagenation" style="text-align:right">
				<script type="text/javascript">
					window.__page=new SnPage(document.getElementById("searchForm"),'/yuyan/defdetail/queryDefdetail.do','${page.totalPage?c}','${page.currentPage?c}');
				</script>
...
<div id="saveDialog" title="业务字典值保存" style="display:none" >
	<input type="hidden" class="savebox" name="saveboxID" id="saveboxID" >
	<div class="box-content">
	<table style="margin-top:10px;font-size:12px;">
		
		<tr style='height:35px;'> 
<td width='140px' align='right'>字典ID：</td>
<td><input type='text' class='savebox' name='saveboxDOC_ID' id='saveboxDOC_ID'  value='${searchbox["ID"]}' disabled="disabled"/>
</td>
</tr>
<tr style='height:35px;'>
<td width='140px' align='right'>字典键：</td>
<td> <input type='text' class='savebox'  name='saveboxDEF_KEY' id='saveboxDEF_KEY' ></td>
</tr>
<tr style='height:35px;'>
<td width='140px' align='right'>字典值：</td>
<td> <input type='text' class='savebox'  name='saveboxDEF_VALUE' id='saveboxDEF_VALUE' ></td>
</tr>
<tr style='height:35px;'>
<td width='140px' align='right'>状态：</td>
<td> <input type='text' class='savebox'  name='saveboxSTATE' id='saveboxSTATE' ></td>
</tr>
<tr style='height:35px;'>
...
<#--批量上传-->
<div class="showBox" id="batchupload" style="display:none;" title="业务字典值批量上传">
	<form action="/yuyan/defdetail/uploadDefdetail.do" method="POST" id="sguploadForm" name="sguploadForm" enctype="multipart/form-data" onsubmit="return false;">
		<div style="text-align: center;margin: 10px 0;">
			<span>路径：</span>
			<input type="hidden" name="importFields" value="DOC_ID,DEF_KEY,DEF_VALUE,STATE,REMARK"/>
	...
	<div align="center">
		<div class="add" >
			...
			<table width="100%" class="up_table" border="1">
				<th>字典编码</th><th>字典名称</th><th>字典键</th><th>字典值</th><th>状态</th><th>备注</th><th>创建时间</th><th>更新时间</th><th>更新用户</th>
			</table>
			<div class="rTitle" align="left">
				<h3>上传注意事项</h3>
			</div>
