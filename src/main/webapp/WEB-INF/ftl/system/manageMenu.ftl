...
$(function() {
	...
	var allFiledsStr = '[{"_CN_":"ID","_KEY_":"ID"},{"_CN_":"上级菜单ID","_KEY_":"PARENT_ID"},{"_CN_":"上级菜单编码","_KEY_":"PARENT_CODE"},{"_CN_":"上级菜单名称","_KEY_":"PARENT_NAME"},{"_CN_":"菜单名称","_KEY_":"NAME","_NOT_NULL_":"1"},{"_CN_":"菜单编码","_KEY_":"CODE"},{"_CN_":"地址","_KEY_":"ACTION","_NOT_NULL_":"1"},{"_CN_":"图标","_KEY_":"ICON","_NOT_NULL_":"1"},{"_CN_":"更新用户","_KEY_":"UPDATE_USER"},{"_CN_":"创建时间","_KEY_":"CREATE_TIME"},{"_CN_":"更新时间","_KEY_":"UPDATE_TIME"}]';
...
<input name='searchbox.CODE' type='text' id='searchbox.CODE'  value='${searchbox["CODE"]}' />
			...
			<div class="searchCenter">
				<input type="hidden" name="exportFields" value="NAME,CODE,PARENT_CODE,PARENT_NAME,ACTION,ICON"/>
...
<td width='140px' align='right'>菜单名称：</td>
<td> <input type='text' class='savebox'  name='saveboxNAME' id='saveboxNAME' ></td>
</tr>
<tr style='height:35px;'>
<td width='140px' align='right'>菜单编码：</td>
<td> <input type='text' class='savebox'  name='saveboxCODE' id='saveboxCODE' ></td>
</tr>
<tr style='height:35px;'>
<td width='140px' align='right'>上级菜单ID：</td>
<td> <input type='text' class='savebox'  name='saveboxPARENT_ID' id='saveboxPARENT_ID' ></td>
</tr>
<tr style='height:35px;'>
<td width='140px' align='right'>地址：</td>
<td> <input type='text' class='savebox'  name='saveboxACTION' id='saveboxACTION' ></td>
</tr>
<tr style='height:35px;'>
<td width='140px' align='right'>图标：</td>
<td> <input type='text' class='savebox'  name='saveboxICON' id='saveboxICON' ></td>
</tr>
	...
	<div align="center">
		<div class="add" >
			...
			<table width="100%" class="up_table" border="1">
				<th>菜单名称</th><th>菜单编码</th><th>上级菜单编码</th><th>上级菜单名称</th><th>地址</th><th>图标</th>
			</table>
			<div class="rTitle" align="left">
				<h3>上传注意事项</h3>
			</div>
